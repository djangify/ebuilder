    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_file', models.FileField(blank=True, null=True, storage=ebuilder.storage.PublicStorage(), upload_to='products/previews/')),
                ('preview_image', models.ImageField(blank=True, null=True, storage=ebuilder.storage.PublicStorage(), upload_to='products/images/')),
                ('video_url', models.URLField(blank=True, help_text='Optional YouTube or Vimeo URL to display on the product page', null=True)),
                ('video_file', models.FileField(blank=True, help_text='Upload a short MP4 file to display as product video', null=True, storage=ebuilder.storage.PublicStorage(), upload_to='products/videos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, storage=ebuilder.storage.SecureStorage(), upload_to='products/downloads/')),
